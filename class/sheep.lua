SheepSprite = love.graphics.newImage(path_gfx .. 'sheep' .. ext_gfx)

Sheep = class('Sheep')
function Sheep:initialize(x, y)
...
function Sheep:draw()
	...
	love.graphics.draw(SheepSprite, self.phys_body:getX(), self.phys_body:getY(), self.phys_body:getAngle(), 1, 1, 16, 16)
end